...
<html dir="ltr" lang="en">
  ...
  // function redirectToUpdateAnswer(questionId){
  //      alert(questionId);
      
  //      window.location.href="newUpdateAnswer.php";
  // }
       ...
       <!-- <div class="page-breadcrumb">
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title"><?php echo 'Q'.$result['id']." " ; echo $result['question']; ?></h5>
                  <p>
                    <?php echo "<b>Ans. </b>".$result['answer'];?>
                  </p>
                 
                  <button class="btn btn-success text-white" type="button" name="shift" id="shift" onClick="window.location.href='newUpdateAnswer.php?id=<?php echo $result['id'];?>'">
                   Update
                  </button>
